...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_event', 'time', orm['website.event:time'])
        
        # Changing field 'Event.date'
        # (to signature: django.db.models.fields.DateField())
        db.alter_column('website_event', 'date', orm['website.event:date'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('website_event', 'time')
    ...
    models = {
        ...
        'website.event': {
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': "'00:00'"}),
